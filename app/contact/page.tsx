...
export default function Contact() {
  return (
    <div className="flex flex-col flex-1 items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 font-sans">
      <main className="relative z-10 flex flex-1 w-full max-w-3xl flex-col gap-10 py-16 px-8 sm:px-16">
        {/* Page header */}
        ...
        <section className="flex flex-col gap-4">
          <a
            ...
            className="group flex items-center gap-4 bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-colors"
          >
