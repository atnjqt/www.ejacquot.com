      ...
      <main className="flex flex-1 w-full max-w-3xl flex-col gap-12 py-24 px-8 sm:px-16 bg-white dark:bg-black">
        ...
        <section className="flex flex-wrap gap-4 text-sm font-medium">
          <a
            ...
            className="flex items-center gap-2 rounded-full border border-zinc-200 dark:border-zinc-700 px-4 py-2 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
          >
